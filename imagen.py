...
def initialize_configuration():
    ...
    return onnx, data_manager

onnx, data_manager = initialize_configuration()

def my_function(text_input, open_ai_key):
...
def main():
    ...
    if st.button('generate', key='button1'):
        try:
            image, is_cached = my_function(text_input, open_ai_key)
